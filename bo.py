...
async def runing(link):
    ...
    while True:
        ...
        while time.time() < selesai:
            ...
            console.clear()
            panel = Panel(Align.left(statusnya), border_style="bright_yellow", title="[ ATTACKING ]")
            console.print(panel)
...
async def console_interface():
    console.clear()
    panel = Panel(Align.left("DDoS Bot Ready"), border_style="bright_yellow", title="[ DDoS ]")
    console.print(panel)
    link = console.input("[bold bright_red][[bold green]+[bold bright_red]] [ [bold bright_white]TARGET URL [bold bright_red]] [bold bright_green]: ")
    console.clear()
    await runing(link)
